...
# Read in data from the ICEWS2 package
library(ICEWS2)
data(icews)
library(foreign)
...
training.sample <- icews[icews$year>=1998 & icews$year<=2007,]  # note that this includes 1998 unlike SAE
...
# A mini-daset for the test-period predictions and observed outcomes
...
# Footnote 13: Comparing average with EBMA

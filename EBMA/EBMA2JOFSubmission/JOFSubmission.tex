...
Bayesian model averaging (EBMA), method first proposed by
...
miss-estimate model weights.  Too much weight will given to poor
...
lead to miss-specification of model weights when data is sparse in the
calibration period.)
...
feel a $c$ value at $0.05$ a good default choice, although the

...
setwd(dd)
dat<-read.csv(header=T,"/Users/florianhollenbach/Documents/Duke/Summer10/Ward/Task/ensembleBMA4Florian/data/International crisis.csv")
...
c<-cor(dat[,c(3,5,7,8)],use="complete.obs") 
print(xtable(c))           
...
pdf("/Users/florianhollenbach/Documents/Duke/Summer10/Ward/Task/ensembleBMA4Florian/graphics/BMAdensityInt.pdf",
    width=5, height=5)

...
setwd(dd)
dat<-read.csv(header=T,"/Users/florianhollenbach/Documents/Duke/Summer10/Ward/Task/ensembleBMA4Florian/data/Insurgency.csv")
...
pdf("/Users/florianhollenbach/Documents/Duke/Summer10/Ward/Task/ensembleBMA4Florian/graphics/BMAdensityInsurgency1.pdf",
    width=5, height=5)

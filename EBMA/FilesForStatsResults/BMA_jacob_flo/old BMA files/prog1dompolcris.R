...
setwd(dd)
dat<-read.csv(header=T,"/Users/florianhollenbach/Documents/Duke/Summer10/Ward/Task/ensembleBMA4Florian/data/Domestic Political Crisis.csv")
...
pdf("/Users/florianhollenbach/Documents/Duke/Summer10/Ward/Task/ensembleBMA4Florian/graphics/BMAdensityDom.pdf",
    width=5, height=5)
